# SOURCE (Fedora) — reference for the Debian/gemet port of comfyui-toolbox. DO NOT BUILD; port target = rocm/comfyui-toolbox (FROM therock-torch-base).
# NOTE: COPYs many local assets (scripts/*, workflows/*) not yet in this repo — needed to port.
