# SOURCE (Fedora) — reference for the Debian/gemet port of llama.cpp. DO NOT BUILD; port target = rocm/llama-artifacts + rocm/llama-runtime.
# build stage
